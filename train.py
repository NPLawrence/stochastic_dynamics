...
import true_dynamics as dynamics
...
if is_stochastic:
    ...
    f_net = convex_model.dynamics_model(V,n,is_training = True)
...
train_dataset = dynamics.oversampdata(Train_data)
valid_dataset = dynamics.oversampdata(Valid_data)
